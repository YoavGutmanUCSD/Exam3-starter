...
hash_map="src/FileReader.java src/DefaultMap.java src/MyHashMap.java src/MaxHeap.java src/MyHashMapTest.java"
file_student="src/FileReader.java src/Student.java"
javac -cp ${classpath} -d classes/ $file_student $hash_map
